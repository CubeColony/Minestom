 ...
 * @date 13/10/2022
 */
public class TransferEvent implements FinancialEvent {

    private final FinancialAccount account;
    private final FinancialAccount target;
    ...
    public TransferEvent(FinancialAccount account, FinancialAccount target, String reason, double amount, FinancialTransaction.Type type, FinancialTransaction.Action action) {

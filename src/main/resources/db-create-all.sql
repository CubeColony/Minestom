...
create table if not exists transactions (
  ...
  created_at                    datetime not null,
  updated_at                    datetime not null,
  constraint uq_transactions_account_id unique (account_id),
...
create table if not exists players_friendship_requests (
...
create index ix_transactions_player_account_id on transactions (player_account_id);
alter table transactions add constraint fk_transactions_player_account_id foreign key (player_account_id) references player_accounts (id) on delete restrict on update restrict;

alter table transactions add constraint fk_transactions_account_id foreign key (account_id) references bank_accounts (id) on delete restrict on update restrict;
